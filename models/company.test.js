...
describe("findAll", function () {
  ...
  test("works: min and max employees filters", async function () {
  ...
  test("works: name max employees filters", async function () {
    let companies = await Company.findAll({ name: 3, maxEmployees: 2 });
    expect(companies).toEqual([]);
  });
});
